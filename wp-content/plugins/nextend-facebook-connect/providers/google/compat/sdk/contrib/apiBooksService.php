...
class Annotation extends apiModel {
    ...
    public function setPageIds(/* array(string) */
        $pageIds) {
...
class Annotations extends apiModel {
    ...
    public function setItems(/* array(Annotation) */
        $items) {
...
class Bookshelves extends apiModel {
    ...
    public function setItems(/* array(Bookshelf) */
        $items) {
...
class DownloadAccesses extends apiModel {
    ...
    public function setDownloadAccessList(/* array(DownloadAccessRestriction) */
        $downloadAccessList) {
...
class VolumeVolumeInfo extends apiModel {
    ...
    public function setAuthors(/* array(string) */
        $authors) {
...
class Volumes extends apiModel {
    ...
    public function setItems(/* array(Volume) */
        $items) {
