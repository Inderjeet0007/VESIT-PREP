...
class Result extends apiModel {
    ...
    public function setInvalidRules(/* array(string) */
        $invalidRules) {
...
class ResultFormattedResultsRuleResults extends apiModel {
    ...
    public function setUrlBlocks(/* array(ResultFormattedResultsRuleResultsUrlBlocks) */
        $urlBlocks) {
...
class ResultFormattedResultsRuleResultsUrlBlocksHeader extends apiModel {
    ...
    public function setArgs(/* array(ResultFormattedResultsRuleResultsUrlBlocksHeaderArgs) */
        $args) {
...
class ResultFormattedResultsRuleResultsUrlBlocksUrls extends apiModel {
    ...
    public function setDetails(/* array(ResultFormattedResultsRuleResultsUrlBlocksUrlsDetails) */
        $details) {
...
class ResultFormattedResultsRuleResultsUrlBlocksUrlsDetails extends apiModel {
    ...
    public function setArgs(/* array(ResultFormattedResultsRuleResultsUrlBlocksUrlsDetailsArgs) */
        $args) {
...
class ResultFormattedResultsRuleResultsUrlBlocksUrlsResult extends apiModel {
    ...
    public function setArgs(/* array(ResultFormattedResultsRuleResultsUrlBlocksUrlsResultArgs) */
        $args) {
