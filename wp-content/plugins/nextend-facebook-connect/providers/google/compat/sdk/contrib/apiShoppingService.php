...
class Product extends apiModel {
    ...
    public function setRecommendations(/* array(ProductRecommendations) */
        $recommendations) {
    ...
    public function setCategories(/* array(ShoppingModelCategoryJsonV1) */
        $categories) {
...
class ProductRecommendations extends apiModel {
    ...
    public function setRecommendationList(/* array(ProductRecommendationsRecommendationList) */
        $recommendationList) {
...
class Products extends apiModel {
    ...
    public function setPromotions(/* array(ProductsPromotions) */
        $promotions) {
    ...
    public function setStores(/* array(ProductsStores) */
        $stores) {
    ...
    public function setItems(/* array(Product) */
        $items) {
    ...
    public function setFacets(/* array(ProductsFacets) */
        $facets) {
    ...
    public function setRedirects(/* array(string) */
        $redirects) {
    ...
    public function setShelfSpaceAds(/* array(ProductsShelfSpaceAds) */
        $shelfSpaceAds) {
    ...
    public function setRelatedQueries(/* array(string) */
        $relatedQueries) {
...
class ProductsFacets extends apiModel {
    ...
    public function setBuckets(/* array(ProductsFacetsBuckets) */
        $buckets) {
...
class ProductsPromotions extends apiModel {
    ...
    public function setCustomFields(/* array(ProductsPromotionsCustomFields) */
        $customFields) {
...
class ShoppingModelCategoryJsonV1 extends apiModel {
    ...
    public function setParents(/* array(string) */
        $parents) {
...
class ShoppingModelDebugJsonV1 extends apiModel {
    ...
    public function setBackendTimes(/* array(ShoppingModelDebugJsonV1BackendTimes) */
        $backendTimes) {
...
class ShoppingModelProductJsonV1 extends apiModel {
    ...
    public function setImages(/* array(ShoppingModelProductJsonV1Images) */
        $images) {
    ...
    public function setInventories(/* array(ShoppingModelProductJsonV1Inventories) */
        $inventories) {
    ...
    public function setInternal8(/* array(string) */
        $internal8) {
    ...
    public function setGtins(/* array(string) */
        $gtins) {
    ...
    public function setInternal1(/* array(string) */
        $internal1) {
    ...
    public function setInternal4(/* array(ShoppingModelProductJsonV1Internal4) */
        $internal4) {
    ...
    public function setAttributes(/* array(ShoppingModelProductJsonV1Attributes) */
        $attributes) {
    ...
    public function setCategories(/* array(string) */
        $categories) {
    ...
    public function setInternal10(/* array(string) */
        $internal10) {
...
class ShoppingModelProductJsonV1Images extends apiModel {
    ...
    public function setThumbnails(/* array(ShoppingModelProductJsonV1ImagesThumbnails) */
        $thumbnails) {
