...
class Context extends apiModel {
    ...
    public function setFacets(/* array(ContextFacets) */
        $facets) {
...
class Promotion extends apiModel {
    ...
    public function setBodyLines(/* array(PromotionBodyLines) */
        $bodyLines) {
...
class Search extends apiModel {
    ...
    public function setPromotions(/* array(Promotion) */
        $promotions) {
    ...
    public function setItems(/* array(Result) */
        $items) {
