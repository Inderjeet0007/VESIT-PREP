...
class AnalyticsSnapshot extends apiModel {
    ...
    public function setCountries(/* array(StringCount) */
        $countries) {
    ...
    public function setPlatforms(/* array(StringCount) */
        $platforms) {
    ...
    public function setBrowsers(/* array(StringCount) */
        $browsers) {
    ...
    public function setReferrers(/* array(StringCount) */
        $referrers) {
...
class UrlHistory extends apiModel {
    ...
    public function setItems(/* array(Url) */
        $items) {
